...
$sql = "INSERT INTO `$table`
 (nr, tip_scoala, nume_scoala, adresa, telefon, puncte_reper, sector)
 VALUES (?,?,?,?,?,?,?)
 ON DUPLICATE KEY UPDATE
   nr=VALUES(nr), tip_scoala=VALUES(tip_scoala), adresa=VALUES(adresa),
   telefon=VALUES(telefon), puncte_reper=VALUES(puncte_reper), sector=VALUES(sector)";
