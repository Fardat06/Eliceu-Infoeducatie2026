...
<div class="page-wrapper">
  ...
  <div class="shop-banner">
    <div>
      <h1 style='color:#fff;'>Lista mea de licee</h1>
      <p style='color:#fff;'>Liceele salvate de tine. Sortează, compară și decide-te.</p>
    </div>
  ...
  <div class="search-bar-wrap">
    <div class="search-input-wrap">
      ...
      <input class="search-input" id="searchInput" name="searchInput" type="text"
        placeholder="Caută un liceu, profil sau specializare…">
    </div>
